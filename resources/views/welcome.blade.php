...
<section class="about-parallax">
  <div class="about-parallax-overlay">
    <div class="container">
      <h2 class="section-title text-white text-center">Des Kréyations qui laissent une empreinte</h2>
      ...
      <div class="mt-8 text-white">
        <div class="flex flex-wrap justify-center max-w-4xl mx-auto px-4">
