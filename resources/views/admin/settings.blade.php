                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="default_description" name="default_description" rows="3">{{ config('seo.default_description', '') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="default_keywords" name="default_keywords" value="{{ config('seo.default_keywords', '') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="url" class="form-control" name="social_facebook" placeholder="URL Facebook" value="{{ config('seo.social_facebook', '') }}">
                                    </div>
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fab fa-twitter"></i></span>
                                        </div>
                                        <input type="url" class="form-control" name="social_twitter" placeholder="URL Twitter" value="{{ config('seo.social_twitter', '') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="url" class="form-control" name="social_instagram" placeholder="URL Instagram" value="{{ config('seo.social_instagram', '') }}">
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fab fa-linkedin"></i></span>
                                        </div>
                                        <input type="url" class="form-control" name="social_linkedin" placeholder="URL LinkedIn" value="{{ config('seo.social_linkedin', '') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form method="POST" action="{{ route('admin.settings.seo.page', ['page' => 'home']) }}" class="pageSettingsForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="home_title" name="title" value="{{ config('seo.pages.home.title', 'Accueil | ' . config('app.name')) }}">
                                </div>
                                
                                <div class="form-group">
                                    <label for="home_description">Description</label>
                                    <textarea class="form-control" id="home_description" name="description" rows="3">{{ config('seo.pages.home.description', '') }}</textarea>
                                </div>
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <form method="POST" action="{{ route('admin.settings.seo.page', ['page' => 'contact']) }}" class="pageSettingsForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="contact_title" name="title" value="{{ config('seo.pages.contact.title', 'Contactez-nous | ' . config('app.name')) }}">
                                </div>
                                
                                <div class="form-group">
                                    <label for="contact_description">Description</label>
                                    <textarea class="form-control" id="contact_description" name="description" rows="3">{{ config('seo.pages.contact.description', 'Prenez contact avec notre équipe pour discuter de vos projets ou obtenir plus d\'informations sur nos services.') }}</textarea>
                                </div>
                        ...
                        <div class="tab-pane fade" id="offres" role="tabpanel" aria-labelledby="offres-tab">
                            <form method="POST" action="{{ route('admin.settings.seo.page', ['page' => 'offres']) }}" class="pageSettingsForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="offres_title" name="title" value="{{ config('seo.pages.offres.title', 'Nos Offres | ' . config('app.name')) }}">
                                </div>
                                
                                <div class="form-group">
                                    <label for="offres_description">Description</label>
                                    <textarea class="form-control" id="offres_description" name="description" rows="3">{{ config('seo.pages.offres.description', 'Découvrez nos offres et tarifs adaptés à vos besoins. Solutions sur mesure pour tous vos projets.') }}</textarea>
                                </div>
                        ...
                        <div class="tab-pane fade" id="client" role="tabpanel" aria-labelledby="client-tab">
                            <form method="POST" action="{{ route('admin.settings.seo.page', ['page' => 'client']) }}" class="pageSettingsForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="client_title" name="title" value="{{ config('seo.pages.client.title', 'Espace Client | ' . config('app.name')) }}">
                                </div>
                                
                                <div class="form-group">
                                    <label for="client_description">Description</label>
                                    <textarea class="form-control" id="client_description" name="description" rows="3">{{ config('seo.pages.client.description', 'Accédez à votre espace client pour gérer vos projets et suivre vos demandes en cours.') }}</textarea>
                                </div>
...
<script>
    $(function() {
        // Afficher un message lors de la soumission des formulaires
        $('#accountSettingsForm, #seoForm, .pageSettingsForm').on('submit', function(e) {
            e.preventDefault();
            ...
            } else if (formId === 'seoForm') {
                title = 'Paramètres SEO du site';
            } else {
                title = 'Paramètres SEO de la page';
            }
            
            // Simuler le succès pour l'instant (l'implémentation réelle sera à faire)
            Swal.fire({
                title: 'Configuration en cours...',
                text: 'Les routes pour mettre à jour les paramètres ne sont pas encore implémentées.',
                icon: 'info',
