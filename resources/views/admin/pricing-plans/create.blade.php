...
<div class="container-fluid px-4">
    <h1 class="mt-4">Créer un Plan Tarifaire</h1>
        ...
        <div class="card-body">
            <form action="{{ route('admin.pricing-plans.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('monthly_price') is-invalid @enderror" id="monthly_price" name="monthly_price" value="{{ old('monthly_price', 0) }}">
                            </div>
                            @error('monthly_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">€</span>
                                <input type="number" step="0.01" class="form-control @error('annual_price') is-invalid @enderror" id="annual_price" name="annual_price" value="{{ old('annual_price', 0) }}">
                            </div>
                            @error('annual_price')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('intro_text') is-invalid @enderror" id="intro_text" name="intro_text" value="{{ old('intro_text') }}">
                            @error('intro_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('button_text') is-invalid @enderror" id="button_text" name="button_text" value="{{ old('button_text', 'Choisir ce plan') }}">
                            @error('button_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('features') is-invalid @enderror" id="features" name="features" rows="5">{{ old('features') }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3" id="highlight_text_container" style="{{ old('is_highlighted') ? '' : 'display: none;' }}">
                            <label for="highlight_text" class="form-label">Texte de mise en avant</label>
                            <input type="text" class="form-control @error('highlight_text') is-invalid @enderror" id="highlight_text" name="highlight_text" value="{{ old('highlight_text', 'Recommandé') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="is_custom_plan" name="is_custom_plan" value="1" {{ old('is_custom_plan') ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_custom_plan">Plan sur mesure</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3" id="custom_plan_text_container" style="{{ old('is_custom_plan') ? '' : 'display: none;' }}">
                            <label for="custom_plan_text" class="form-label">Texte du plan sur mesure</label>
                            <input type="text" class="form-control @error('custom_plan_text') is-invalid @enderror" id="custom_plan_text" name="custom_plan_text" value="{{ old('custom_plan_text', 'Contactez-nous pour un devis') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('order') is-invalid @enderror" id="order" name="order" value="{{ old('order', 999) }}" min="1" max="999">
