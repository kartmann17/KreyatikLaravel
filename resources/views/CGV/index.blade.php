...
<section class="bg-gradient-to-b from-gray-50 to-white py-16">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 animate-fade-in">Conditions Générales de Vente</h1>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">Les conditions générales de vente de Kréyatik Studio</p>
        </div>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 transform hover:scale-[1.01] transition-transform duration-300">
            <div class="space-y-12">
                ...
                <div class="group">
                    ...
                    <div class="text-gray-600 pl-9">
                        <p>Dernière mise à jour : <span class="font-semibold">{{ date('d/m/Y') }}</span></p>
                        <p class="mt-2">Pour toute question concernant nos CGV, contactez-nous à :
